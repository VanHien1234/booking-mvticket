...
import { layThongTinNguoiDungAction } from 'redux/actions/QuanLyUserAction';
            ...
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-3">
                    ...
                    <div className="mb-0 h-full flex flex-col items-center" style={{ marginBottom: 0 }}>
                        <Button
                        style={{backgroundColor:'red',border:'none'}} size="medium" type="primary" shape="round"
                        onClick={() => {
...
export default function CheckoutTab(props) {
    ...
    const operations = <Fragment>
        {!_.isEmpty(userLogin) ? <Fragment> <Button shape="circle" size='large' style={{backgroundColor:'green',border:'none',color:'white',fontWeight:'bold' }} className="mr-2 "
            onClick={() => {
                history.push('/profile')
            }}>{userLogin.taiKhoan.substr(0, 1)}</Button>
            <NavLink to="/profile" style={{fontWeight:'bold',color:'black'}} className="mr-4">{userLogin.hoTen}</NavLink>
            <Button 
            onClick={() => {
            ...
            }} style={{backgroundColor:'red',border:'none'}} size="medium" type="primary" shape="round" className="mr-3">Đăng xuất  <i class="fas fa-sign-out-alt ml-2"></i></Button> </Fragment>: ''} 
